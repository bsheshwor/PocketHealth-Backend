# Generated by Django 3.2.8 on 2022-04-01 12:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.BooleanField(blank=True, db_index=True, max_length=100, null=True)),
                ('gender', models.CharField(choices=[('1', 'male'), ('2', 'female'), ('3', 'other'), ('4', 'unknown')], db_index=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('practitioner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qualification', to='account.practitioner')),
            ],
        ),
        migrations.CreateModel(
            name='RelatedPerson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=255, null=True)),
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='code', to='account.qualification')),
            ],
        ),
        migrations.CreateModel(
            name='Program',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='period', to='account.address')),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='period', to='account.contact')),
                ('contactpoint', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='period', to='account.contactpoint')),
                ...
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='period', to='account.qualification')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
        ...
        migrations.AddField(
            model_name='organization',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='managingOrganization', to='account.patient'),
        ),
        migrations.AddField(
            model_name='organization',
            name='qualification',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issuer', to='account.qualification'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maritalStatus', to='account.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Link',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='link', to='account.patient')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='humanname',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='name', to='account.patient'),
        ),
        migrations.AddField(
            model_name='humanname',
            name='practitioner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='name', to='account.practitioner'),
        ),
        migrations.AddField(
            model_name='humanname',
            name='relatedperson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deceased', to='account.patient')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='contact',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contact', to='account.patient'),
        ),
        migrations.CreateModel(
            name='Communication',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='communication', to='account.patient')),
                ('practitioner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='communication', to='account.practitioner')),
            ],
        ),
        migrations.CreateModel(
            name='availableTime',
        ...
        migrations.AddField(
            model_name='address',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='address', to='account.patient'),
        ),
        migrations.AddField(
            model_name='address',
            name='practitioner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='address', to='account.practitioner'),
        ),
        migrations.AddField(
            model_name='address',
            name='relatedperson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telecom', to='account.patient')),
                ('practitioner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telecom', to='account.practitioner')),
            ],
