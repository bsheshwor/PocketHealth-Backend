...
class Period(models.Model):
    user = models.ForeignKey(Practitioner, related_name="period",on_delete= models.CASCADE)
...
class ContactPoint(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="contact_point",on_delete= models.CASCADE)
...
class Deceased(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="deceased",on_delete= models.CASCADE)
...
class Address(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="address",on_delete= models.CASCADE)
...
class HumanName(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="human_name",on_delete= models.CASCADE)
...
class MaritalStatus(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="marital_status",on_delete= models.CASCADE)
...
class Contact(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="contact",on_delete= models.CASCADE)
...
class Communication(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="communication",on_delete= models.CASCADE)
...
class Link(models.Model):
    ...
    user = models.ForeignKey(Practitioner, related_name="link", on_delete= models.CASCADE,null=True, blank=True)
